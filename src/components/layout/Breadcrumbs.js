...
const Breadcrumbs = ({ selectedCategory, setSelectedCategory, selectedProduct, setSelectedProduct, searchQuery, setSearchQuery }) => {
  return (
    <div className="max-w-7xl mx-auto px-4 py-3 text-sm text-gray-600">
      <div className="flex items-center space-x-2 flex-wrap">
        <button 
          onClick={() => { setSelectedCategory('all'); setSelectedProduct(null); setSearchQuery(''); }}
